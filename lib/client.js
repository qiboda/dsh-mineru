  ...
  factory: (require) => {
    ...
    if (document.getElementById(STYLE_ID) === null) {
      ...
      style.textContent = [
        ...
        '.dsh-mineru-btn-primary { background: var(--dsw-alias-button-primary-fill, #2b3a67); border-color: var(--dsw-alias-button-primary-fill, #3a5091); color: var(--dsw-alias-label-primary-foreground, #dbe4ff); }',
        ...
        '  border-color: var(--dsw-alias-button-primary-fill, #3a5091); color: var(--dsw-alias-label-primary-foreground, #dbe4ff); }',
        ...
        '.dsh-mineru-item.active { background: var(--dsw-alias-interactive-bg-hover, #1f2740); border-color: var(--dsw-alias-button-primary-fill, #3a5091); }',
        ...
        '.dsh-mineru-pick-btn { border: 1px solid var(--dsw-alias-button-primary-fill, #3a5091); background: var(--dsw-alias-button-primary-fill, #243354); color: var(--dsw-alias-label-primary-foreground, #dbe4ff);',
