  ...
  factory: (require) => {
    ...
    if (document.getElementById(STYLE_ID) === null) {
      ...
      style.textContent = [
        ...
        '  color: var(--dsw-alias-label-primary, var(--dsw-alias-label-primary, #d8dee9)); }',
        ...
        '  display: flex; flex-direction: column; background: var(--dsw-specific-menu, #10131a);',
        '  border: 1px solid var(--dsw-alias-border-inverted, #2a3040); border-radius: 12px; overflow: hidden;',
        ...
        '.dsh-mineru-btn { border: 1px solid var(--dsw-alias-border-inverted, #2a3040); background: var(--dsw-specific-menu, #1c2230); color: var(--dsw-alias-label-secondary, #c0caf5);',
        ...
        '.dsh-mineru-btn-primary { background: var(--dsw-alias-button-primary-fill, #2b3a67); border-color: var(--dsw-alias-button-primary-border, #3a5091); color: var(--dsw-alias-label-primary, #dbe4ff); }',
        ...
        '  border-color: var(--dsw-alias-button-primary-border, #3a5091); color: var(--dsw-alias-label-primary, #dbe4ff); }',
        '.dsh-mineru-item-menu { position: absolute; right: 0; top: calc(100% + 2px); z-index: 20;',
        '  min-width: 150px; padding: 4px; display: none; background: var(--dsw-specific-menu, #1c2230);',
        '  border: 1px solid var(--dsw-alias-border-inverted, #2a3040); border-radius: 8px; box-shadow: 0 8px 24px rgba(0,0,0,.5); }',
        ...
        '.dsh-mineru-item.active { background: var(--dsw-alias-interactive-bg-hover, #1f2740); border-color: var(--dsw-alias-button-primary-border, #3a5091); }',
        ...
        '  border-left: 1px solid var(--dsw-alias-border-inverted, #2a3040); }',
        '.dsh-mineru-resizer:hover, .dsh-mineru-resizer.dragging { background: var(--dsw-alias-button-primary-border, #3a5091); }',
        ...
        '  border: 1px solid var(--dsw-alias-button-primary-border, #3a5091); border-radius: 8px; background: var(--dsw-alias-button-primary-fill, #243354); color: var(--dsw-alias-label-primary, #dbe4ff);',
        ...
        '  color: var(--dsw-alias-label-primary, var(--dsw-alias-label-primary, #d8dee9)); background: var(--dsw-specific-menu, var(--dsw-specific-menu, #1c2230));',
        '  border: 1px solid var(--dsw-alias-border-inverted, var(--dsw-alias-border-inverted, #2a3040)); border-radius: 10px;',
        '  padding: 6px 10px; }',
        '.dsh-mineru-quote-dock-head { display: flex; align-items: center; gap: 8px;',
        '  font-size: 12px; font-weight: 600; }',
        '.dsh-mineru-quote-dock-count { color: var(--dsw-alias-label-tertiary, var(--dsw-alias-label-tertiary, #8b93a7)); font-weight: 400; }',
        '.dsh-mineru-quote-dock-clear, .dsh-mineru-quote-dock-item-remove { border: 0; background: transparent;',
        '  color: var(--dsw-alias-label-tertiary, var(--dsw-alias-label-tertiary, #8b93a7)); cursor: pointer; font-size: 14px; line-height: 1;',
        ...
        '  padding: 4px 6px; border-radius: 6px; background: var(--dsw-alias-bg-layer-1, var(--dsw-alias-bg-layer-1, #11141d)); }',
        '.dsh-mineru-quote-dock-item-title { font-size: 11px; font-weight: 600; white-space: nowrap; }',
        '.dsh-mineru-quote-dock-item-loc { font-size: 10px; color: var(--dsw-alias-label-tertiary, var(--dsw-alias-label-tertiary, #8b93a7));',
        '  white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 40%; }',
        '.dsh-mineru-quote-dock-item-snippet { flex: 1; font-size: 11px; color: var(--dsw-alias-label-secondary, var(--dsw-alias-label-secondary, #c0caf5));',
        '  white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }',
        ...
        '  background: var(--dsw-specific-menu, #1c2230); border: 1px solid var(--dsw-alias-border-inverted, #2a3040); color: var(--dsw-alias-label-primary, #d8dee9); font-size: 12px;',
        ...
        '.dsh-mineru-settings input, .dsh-mineru-settings select { background: var(--dsw-alias-bg-layer-1, var(--dsw-specific-menu, #1c2230));',
        '  border: 1px solid var(--dsw-alias-border-inverted, var(--dsw-alias-border-inverted, #2a3040)); border-radius: 6px; color: var(--dsw-alias-label-primary, var(--dsw-alias-label-primary, #d8dee9));',
        ...
        '.dsh-mineru-settings button { align-self: flex-start; border: 1px solid var(--dsw-alias-button-primary-border, #3a5091); background: var(--dsw-alias-button-primary-fill, #243354);',
        '  color: var(--dsw-alias-label-primary, #dbe4ff); border-radius: 6px; font-size: 12px; padding: 6px 16px; cursor: pointer; }',
        ...
        '.dsh-mineru-pick-btn { border: 1px solid var(--dsw-alias-button-primary-border, #3a5091); background: var(--dsw-alias-button-primary-fill, #243354); color: var(--dsw-alias-label-primary, #dbe4ff);',
    ...
    function applyThemeToFrame(frame, doc) {
      ...
      try {
        ...
        var border = readCssVar('--dsw-alias-border-l2') || 'var(--dsw-alias-border-inverted, #2a3040)'
